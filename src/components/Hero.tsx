...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* <ThreeDpPlayground/> */}
      {/* <div className="absolute inset-0 bg-gradient-to-r from-slate-900/65 via-slate-900/70 to-slate-700/45" /> */}
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          <a
            href="#projects"
            className="px-8 py-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            View Our Projects
          </a>
          <a
            href="#contact"
            className="px-8 py-4 bg-transparent border-2 border-orange-500 hover:bg-orange-500 text-white rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105"
          >
            Get Started
          </a>
        </motion.div>
